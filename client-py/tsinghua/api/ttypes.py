            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i55 in range(_size51):
                        _elem56 = DatasetVersionTreeDTO()
                        _elem56.read(iprot)
                        self.children.append(_elem56)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TaskInfoDto(object):
    ...
    def __init__(self, taskType = None, dataFlowType = None, timeout = None, dataset = None, pyTaskName = None,):
