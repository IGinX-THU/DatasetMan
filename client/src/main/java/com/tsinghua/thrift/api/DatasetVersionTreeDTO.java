            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.children = new java.util.ArrayList<DatasetVersionTreeDTO>(_list58.size);
                @org.apache.thrift.annotation.Nullable DatasetVersionTreeDTO _elem59;
                for (int _i60 = 0; _i60 < _list58.size; ++_i60)
                {
                  _elem59 = new DatasetVersionTreeDTO();
                  _elem59.read(iprot);
      ...
      if (struct.children != null) {
        if (struct.isSetChildren()) {
          oprot.writeFieldBegin(CHILDREN_FIELD_DESC);
          {
            ...
            for (DatasetVersionTreeDTO _iter61 : struct.children)
            {
              _iter61.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetChildren()) {
        {
          ...
          for (DatasetVersionTreeDTO _iter62 : struct.children)
          {
            _iter62.write(oprot);
          }
        }
      ...
      if (incoming.get(11)) {
        {
          ...
          struct.children = new java.util.ArrayList<DatasetVersionTreeDTO>(_list63.size);
          @org.apache.thrift.annotation.Nullable DatasetVersionTreeDTO _elem64;
          for (int _i65 = 0; _i65 < _list63.size; ++_i65)
          {
            _elem64 = new DatasetVersionTreeDTO();
            _elem64.read(iprot);
            struct.children.add(_elem64);
          }
        }
        struct.setChildrenIsSet(true);
      }
