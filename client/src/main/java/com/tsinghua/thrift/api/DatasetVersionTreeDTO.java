            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.children = new java.util.ArrayList<DatasetVersionTreeDTO>(_list50.size);
                @org.apache.thrift.annotation.Nullable DatasetVersionTreeDTO _elem51;
                for (int _i52 = 0; _i52 < _list50.size; ++_i52)
                {
                  _elem51 = new DatasetVersionTreeDTO();
                  _elem51.read(iprot);
      ...
      if (struct.children != null) {
        if (struct.isSetChildren()) {
          oprot.writeFieldBegin(CHILDREN_FIELD_DESC);
          {
            ...
            for (DatasetVersionTreeDTO _iter53 : struct.children)
            {
              _iter53.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetChildren()) {
        {
          ...
          for (DatasetVersionTreeDTO _iter54 : struct.children)
          {
            _iter54.write(oprot);
          }
        }
      ...
      if (incoming.get(11)) {
        {
          ...
          struct.children = new java.util.ArrayList<DatasetVersionTreeDTO>(_list55.size);
          @org.apache.thrift.annotation.Nullable DatasetVersionTreeDTO _elem56;
          for (int _i57 = 0; _i57 < _list55.size; ++_i57)
          {
            _elem56 = new DatasetVersionTreeDTO();
            _elem56.read(iprot);
            struct.children.add(_elem56);
          }
        }
        struct.setChildrenIsSet(true);
      }
